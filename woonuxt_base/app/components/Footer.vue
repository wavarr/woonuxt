  ...
  <footer class="relative w-full bg-gray-800 text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><NuxtLink to="/my-account" class="text-gray-300 hover:text-white transition-colors">My Account</NuxtLink></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><NuxtLink to="/privacy-policy" class="text-gray-300 hover:text-white transition-colors">Privacy Policy</NuxtLink></li>
            <li><NuxtLink to="/terms" class="text-gray-300 hover:text-white transition-colors">Terms & Conditions</NuxtLink></li>
            <li><NuxtLink to="/shipping" class="text-gray-300 hover:text-white transition-colors">Shipping Information</NuxtLink></li>
            <li><NuxtLink to="/faq" class="text-gray-300 hover:text-white transition-colors">FAQ</NuxtLink></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p class="mb-4 text-gray-300">Subscribe to receive updates, access to exclusive deals, and more.</p>
          <form class="flex">
    ...
    <div class="bg-gray-900 py-4">
      <div class="container mx-auto px-4 text-center text-gray-400">
        <p>© {{ new Date().getFullYear() }} ModaPrime USA. All rights reserved.</p>
      </div>
    </div>
    ...
    <div class="wave-bottom">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" class="w-full h-16">
        <path fill="#111827" fill-opacity="1" d="M0,224L48,213.3C96,203,192,181,288,181.3C384,181,480,203,576,224C672,245,768,267,864,261.3C960,256,1056,224,1152,208C1248,192,1344,192,1392,192L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
      </svg>
    </div>
  </footer>
</template>

      ...
      <div class="container flex items-center justify-between py-1.5 relative z-10">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex gap-3 items-center">
            <NuxtLink to="/my-account" class="inline-flex items-center text-[#f1faee] hover:text-[#ffd700]" title="Sign In">
...
// Override the toggleMobileMenu function to control our local state
...
/* Gold accent styling - restored but without oval */
.gold-accent {
